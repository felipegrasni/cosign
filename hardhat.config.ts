...
const accounts = /^0x[0-9a-fA-F]{64}$/.test(serverEnv.privateKey)
...
export default defineConfig({
  ...
  chainDescriptors: {
    42220: { name: "Celo Mainnet", chainType: "generic", blockExplorers: {
      etherscan: { name: "Celoscan", url: "https://celoscan.io", apiUrl: "https://api.etherscan.io/v2/api" }
    } },
    11142220: { name: "Celo Sepolia", chainType: "generic", blockExplorers: {
      blockscout: { name: "Celo Sepolia Blockscout", url: "https://celo-sepolia.blockscout.com", apiUrl: "https://celo-sepolia.blockscout.com/api" }
    } }
  },
