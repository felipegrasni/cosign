...
export default function HomePage() {
  return (
    <main className="landing-page">
      <header className="landing-nav"><Link href="/" className="landing-brand" aria-label="CoSign home"><BrandMark /><strong>CoSign</strong></Link><nav><a href="#how">How it works</a><a href="#public">What is public</a><Link className="button compact" href="/app">Open app <ArrowRight /></Link></nav></header>
      ...
      <footer className="landing-footer"><Link href="/" className="landing-brand" aria-label="CoSign home"><BrandMark /><strong>CoSign</strong></Link><p>Public collaboration cards for Celo and Stacks.</p><Link href="/app">Open app <ArrowRight /></Link></footer>
    </main>
  );
}
