  ...
  return (
    <main id="main-content" className="network-entry">
      ...
      <section>
        ...
        <p>Pick the one chain both wallets can sign on. If the wallets live on different networks, create separate cards because CoSign does not mirror receipts across chains.</p>
