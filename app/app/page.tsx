...
export default function AppEntryPage() {
  ...
  return (
      <main className="network-entry"><Link href="/" className="landing-brand" aria-label="CoSign home"><BrandMark /><strong>CoSign</strong></Link><section><span className="eyebrow">Choose a network</span><h1>Where does your wallet live?</h1><p>Pick the one network both wallets can sign on. If the wallets live on different chains, create separate cards because CoSign never mirrors a receipt automatically.</p><div className="entry-grid"><Link href="/app/celo"><Smartphone aria-hidden="true" /><span>Celo</span><strong>MiniPay-ready</strong><ArrowRight aria-hidden="true" /></Link><Link href="/app/stacks"><WalletCards aria-hidden="true" /><span>Stacks</span><strong>Bitcoin-secured</strong><ArrowRight aria-hidden="true" /></Link></div></section></main>
  );
}
