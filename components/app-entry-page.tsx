  ...
  return (
    <main id="main-content" className="network-entry">
      ...
      <section>
        ...
        <p>Public cards stay readable without connecting a wallet, but creating or co-signing only works on the network you choose. If the wallets live on different networks, create one card on Celo and another on Stacks because CoSign does not carry the same receipt across networks.</p>
